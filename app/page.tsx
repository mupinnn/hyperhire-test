...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="overflow-visible max-w-7xl mx-auto w-full grow items-center justify-center flex flex-col px-4 pt-9 pb-[60px] gap-9 xl:gap-[60px]">
        <div className="grid grid-cols-1 gap-9 w-full xl:grid-cols-2">
          <div className="flex flex-col gap-4 font-black font-notoKR">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3, ease: 'easeOut' }}>
              <Tooltip color="blue">
                <p>풀타임, 파트타임</p>
              </Tooltip>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-4">
              <h1 className="text-4xl text-white !leading-snug sm:text-white/90 xl:text-5xl">
                최고의 실력을 가진 외국인 인재를 찾고 계신가요?
              </h1>
              <p className="text-lg text-white/80 sm:text-white/90 xl:text-2xl">
                법률 및 인사관리 부담없이 1주일 이내에 원격으로 채용해보세요.
              </p>
              <p className="hidden underline text-white xl:block xl:!mt-6 xl:text-lg">개발자가 필요하신가요?</p>
            </motion.div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5, ease: 'easeOut' }}
              className="hidden grid-cols-3 gap-12 xl:grid font-notoKR text-white mt-[60px]">
              <div className="space-y-2 pt-2 border-t border-white">
                <p>평균 월 120만원</p>
                <p className="text-white/80">임금을 해당 국가를 기준으로 계산합니다.</p>
              </div>
              <div className="space-y-2 pt-2 border-t border-white">
                <p>최대 3회 인력교체</p>
                <p className="text-white/80">막상 채용해보니 맞지 않아도 걱정하지 마세요. </p>
              </div>
              <div className="space-y-2 pt-2 border-t border-white">
                <p>평균 3일, 최대 10일</p>
                <p className="text-white/80">급하게 사람이 필요한 경우에도 빠른 채용이 가능합니다.</p>
              </div>
            </motion.div>
          </div>
            ...
            <Tooltip color="green" className="mb-6 flex items-center gap-2.5" arrowPosition="bottomCenter">
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  fill="#00C696"
                />
                <path d="M13.1904 4L13.1904 5.8291" stroke="#00C696" strokeWidth="2" strokeLinecap="round" />
                <path d="M13.1904 19.418L13.1904 21.2471" stroke="#00C696" strokeWidth="2" strokeLinecap="round" />
              </svg>
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, ease: 'easeOut' }}
          className="flex flex-col gap-4 self-start xl:hidden">
