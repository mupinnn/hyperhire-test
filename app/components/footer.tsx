...
export function Footer() {
  return (
    <footer className="px-4 py-16 flex flex-col bg-lotion text-blue-gray/80 font-notoKR">
      ...
      <div className="grid grid-cols-2 gap-2 font-notoKR text-sm mt-[60px]">
      ...
      <div className="space-y-[10px] text-sm mt-9">
      ...
      <div className="space-y-[10px] text-sm font-notoKR mt-9">
        <p>주소 ADDRESS</p>
        <div className="space-y-[5px] text-blue-gray/60">
          <p>서울특별시 강남대로 479, 지하 1층 238호 </p>
          <p className="font-sans">D-138, Street number 11, Jagjeet Nagar, North East Delhi, New Delhi, 110053 India</p>
        </div>
      </div>

      <p className="text-sm text-blue-gray/60 mt-9 font-sans">&copy; 2023 Hyperhire</p>
    </footer>
  );
}
